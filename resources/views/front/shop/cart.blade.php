    ...
    <div class="shopping-cart spad">
        <div class="container">
            <div class="row">
                                ...
                                <tr>
                                    ...
                                    <th>
                                        <i onclick="confirm('Are you sure to delete all carts?') === true ? destroyCart() : ''"
                                           class="ti-close cursor-pointer"></i>
                                    </th>
                                </tr>
                                </thead>
                                <tbody>
                                @foreach($carts as $cart)
                                    <tr data-rowid="{{$cart->rowId}}">
                                        ...
                                        <td class="qua-col first-row">
                                            <div class="pro-qty">
                                                <input type="text" value="{{$cart->qty}}" data-rowId="{{$cart->rowId}}"ơ>
                                            </div>
                                        </td>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="cart-buttons">
                                    <a href="#" class="primary-btn continue-shop">Continue Shop</a>
                            ...
                            <div class="col-lg-4 offset-lg-4">
                                <div class="proceed-checkout">
                                    ...
                                    <a href="{{route('checkout.index')}}" class="proceed-btn">PROCCED TO CHECK OUT</a>
                                </div>
                            </div>
                        </div>
                    </div>
                @else
                    <div class="col-12">
                        <h4 class="text-center text-secondary">Your cart is empty!</h4>
                    </div>
                @endif
            </div>
        </div>
